...
print("\r")
##############################################################################
# Check to see if 3 instances are of type t2.micro or t3.micro
##############################################################################
print('*' * 79)
print("Testing to make sure the running EC2 instances are all of type t2.micro... or t3.micro")
...
for res in range(0, len(responseEC2['Reservations'])):
  for n in range(0,len(responseEC2['Reservations'][res]['Instances'])):
      instance = responseEC2['Reservations'][res]['Instances'][n]
      instance_type = instance['InstanceType']
      instance_id = instance['InstanceId']
 
      if instance_type == "t2.micro" or instance_type == "t3.micro":
          print("InstanceID of: " + instance_id + " and of InstanceType: " + instance_type)
      else:
          checkInstanceTypeMismatch = True # Fixed variable name to match your 'if' below
          print("Incorrect Ec2 Instance Type of " + str(instance_type) + " set.")
