...
####################################################################
sudo -u ubuntu git clone https://github.com/rayyanrafan7/coursera-cloud-computing.git

# Start the nodejs app where it is located via PM2
# https://pm2.keymetrics.io/docs/usage/quick-start
cd /home/ubuntu/coursera-cloud-computing/itmo-463-563/module-06

sudo cp /home/ubuntu/coursera-cloud-computing/itmo-463-563/module-06/default /etc/nginx/sites-available/default
